...
public class SMSPresenterImpl implements SMSPresenter {
    ...
    public void deleteSMS() {
        ...
        mSMSView.showTip(R.string.rule_tip_sms_deleted);
    }
            ...
            public void run() {
                try {
                    ...
                    if (!file.exists() || !file.isFile()) {
                        mSMSView.showTipInThread(R.string.menu_import_sms_miss_tip);
                        return;
                    }
                    ...
                    mSMSView.showTipInThread(R.string.menu_import_sms_tip);
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
        ...
        new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    mSMSView.showTipInThread(R.string.menu_export_sms_tip);
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
